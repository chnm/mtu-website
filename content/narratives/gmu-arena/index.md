...
{{< figure id="img1" image="Picture 1.jpg" alt="Yearbook page with three black-and-white action photographs of George Mason basketball players, a season record table, and a quote from player Carlos Yates" caption="Figure 1. Images of George Mason's basketball team as featured in the 1985 yearbook. *By-George!* Yearbook, 1985, p. 230." >}}
...
{{< figure id="img2" image="R0017_B064_F012_001.jpg" alt="Architectural upper level plan drawing showing the circular arena layout connected to an existing gym and pool facility" caption="Figure 2. Architectural plans for the university arena. Facilities Records, Special Collections and Research Center (SCRC), George Mason University, Box 64, Folder 12, 1981." >}}
...
{{< figure id="img3" image="Picture 2.jpg" alt="Yearbook page showing a packed commencement ceremony inside the Patriot Center arena with rows of graduates and a speaker at the podium" caption="Figure 3. Mason's 1985 Commencement ceremeny was the first to be held in the newly completed Patriot Center arena. *By-George!* Yearbook, 1985, p. 205." >}}
...
{{< figure id="img4" image="Picture 3.jpg" alt="Exterior view of the EagleBank Arena at George Mason University showing the south entrance and building signage" caption="Figure 4. Mason's EagleBank Arena. Courtesy of George Mason University Facilities." >}}
