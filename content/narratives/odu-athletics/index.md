...
{{< figure id="image1" image="FootballTeam-Gallaudet-1935.jpg" alt="Football players tackle an opponent on a dusty field with advertising signs visible in the stadium background." caption="Figure 1. Football game between William & Mary Norfolk and Gallaudet, 1935." >}}
...
{{< figure id="image2" image="AdministrationBuilding-Exterior-1936.jpg" alt="A multi-wing brick building with colonial-style architecture, a bare tree in the foreground, and dramatic clouds overhead." caption="Figure 2. Exterior of Administration Building, 1936." >}}

{{< figure id="image3" image="BasketballTeam-AdminGym-1957.jpg" alt="Basketball players leap for the ball near the basket in a packed gymnasium with spectators filling the bleachers." caption="Figure 3. William & Mary Norfolk basketball team in Administration Building gymnasium, 1957." >}}
...
{{< figure id="image4" image="ForemanField-Dedication-HighHat-1936-10-02.jpg" alt="Front page of The High Hat student newspaper with the headline 'Dedication of Stadium Tomorrow.'" caption="Figure 4. Article from student newspaper *The High Hat* regarding the dedication of Foreman Field, October 2, 1936." >}}
...
{{< figure id="image5" image="HealthPhysicalEducationBuilding-EntranceCourtyard-1980s.jpg" alt="Large modernist building with a flat roof and wide concrete courtyard with steps, planters, and lamp posts." caption="Figure 5. Health and Physical Education (HP&E) Building, circa 1980-1989." >}}
...
{{< figure id="image6" image="WomensBball-NITTournament-1977.jpg" alt="Women's basketball players in uniforms raise a large trophy together on the court while coaches and supporters applaud." caption="Figure 6. ODU women's basketball team celebrating National Women's Invitational Tournament championship in Amarillo, TX, 1977." >}}
...
{{< figure id="image7" image="BasketballTeam-VCU-2010.jpg" alt="Two players contest a shot at the basket in a packed arena with ODU Monarchs branding and fans in white shirts." caption="Figure 7. ODU Men's Basketball vs. Virginia Commonwealth University at Ted Constant Convocation Center, 2010." >}}
